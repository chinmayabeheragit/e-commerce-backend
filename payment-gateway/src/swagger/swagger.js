...
module.exports = function (app) {
  let swaggerDefinition = {
    swagger: "2.0",
    info: {
      title: "KIDTRYZ PAYMENT GATEWAY service  API's",
      description: "RESTful API for KIDTRYZ PAYMENT GATEWAY services",
      version: "1.0",
    },
    servers: [
      {
  ...
  let extraOptions = {
    ...
    customSiteTitle: "Swagger - KIDTRYZ PAYMENT GATEWAY",
  };
